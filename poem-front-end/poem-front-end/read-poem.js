...
var loadPoemOnRead = function () { return __awaiter(_this, void 0, void 0, function () {
    var response, data, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, fetch('http://localhost:3000/poems', {
                        method: 'GET',
                        headers: {
            ...
            case 2:
                ...
                data.forEach(function (poem) {
                    ...
                    (_a = document.querySelector('#t')) === null || _a === void 0 ? void 0 : _a.appendChild(cellElement);
                });
                return [3 /*break*/, 4];
            case 3:
                error_1 = _a.sent();
